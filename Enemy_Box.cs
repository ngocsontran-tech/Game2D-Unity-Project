...
public class Enemy_Box : Danger
{
    ...
    private void CreateBreak()
    {
        ...
        newBreak1.GetComponent<Enemy_Box>();
        ...
        newBreak2.GetComponent<Enemy_Box>();
        ...
        newBreak3.GetComponent<Enemy_Box>();
        ...
        newBreak4.GetComponent<Enemy_Box>();
